...
if (isset($_POST["btnDetails"])) {
    ...
    foreach ($data as $result) {
        ...
        echo "選擇操作為__" . $result["info"] . "__金額:" . $result['money'] . "<br>";
        echo "操作前的金錢為:" . $result["balance"] . "<br>";
        echo "操作後的金錢為:" .  $result["newBalance"] . "<br><br>";
    }
}
...
<html>
    ...
    <body>
        <form  align="center"  method="post" action="ShowDetails.php">
